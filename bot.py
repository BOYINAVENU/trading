...
class PolymarketSniperBot:
    ...
    def _get_balance(self) -> float:
        """Get current USDC balance using Web3"""
        try:
            ...
            if Config.DISABLE_SSL_VERIFICATION:
                ...
                w3 = Web3(Web3.HTTPProvider(Config.POLYGON_RPC_URL, session=session))
            else:
            ...
            # Native USDC contract on Polygon (the one that has balance)
